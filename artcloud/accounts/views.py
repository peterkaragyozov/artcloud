...
from artcloud.accounts.forms import SignUpForm, UserProfileForm
from artcloud.accounts.models import UserProfile
...
class UserProfileView(views.UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['arts'] = self.get_object().art_set.all()
